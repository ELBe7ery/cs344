...
//External HW2.cpp definitions
extern void preProcess(uchar4 **h_inputImageRGBA, uchar4 **h_outputImageRGBA,
...
extern void postProcess(const std::string& output_file, uchar4* data_ptr);

extern void cleanUp(void);

extern void referenceCalculation(const uchar4* const rgbaImage, uchar4 *const outputImage,
